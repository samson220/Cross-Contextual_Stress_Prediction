...
#          return 1
#     else:
#         return 2  # or handle values outside these ranges differently if needed
...
# Dictionary to hold best estimators
best_estimators = {}
...
for clf_name, (clf, param_grid) in classifiers.items():
    ...
    save_obj(clf_results, f'/Users/samson/Documents/Final2/wesad/sresults/{clf_name}_F2train_wesad_RS-10kf')

# Creating an ensemble model
ensemble = VotingClassifier(estimators=[(clf_name, clf) for clf_name, clf in best_estimators.items()], voting='soft')
