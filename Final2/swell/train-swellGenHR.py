...
for clf_name, (clf, param_grid) in classifiers.items():
    ...
    clf_random_search = RandomizedSearchCV(clf, param_distributions=param_grid, n_iter=10, cv=kf, scoring='f1_macro', random_state=42, n_jobs=10)
    ...
    save_obj(clf_results, f'/Users/samson/Documents/Final2/swell/resultshr/{clf_name}_F2train_swellhr_RS-10kf')
