...
# Define the function to save an object using pickle
...
for clf_name, (clf, param_grid) in classifiers.items():
    ...
    for i in range(10):
        fold_accuracy = clf_random_search.cv_results_[f'split{i}_test_score'][clf_random_search.best_index_]
        print(f"Fold {i+1}: Accuracy = {fold_accuracy:.5f}")
    ...
    save_obj(clf_results, f'/Users/samson/Documents/Final2/swell/resultshrlf2/{clf_name}_F2train_swellhr_RS-10kf')
