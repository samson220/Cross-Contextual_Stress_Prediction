# Import the model we are using - Swell - Train with All features
...
X = dataset.drop('condition', axis=1).copy()
...
for clf_name, (clf, param_grid) in classifiers.items():
    ...
    save_obj(clf_results, f'/Users/samson/Documents/Final2/swell/results/{clf_name}_F2train_swell_RS-10kf')
